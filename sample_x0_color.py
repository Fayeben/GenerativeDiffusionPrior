...
from imagenet_dataloader.imagenet_dataset_light_lol import ImageFolderDataset
...
def main():
    ...
    def color_cond_fn(x, t, y=None, x_lr=None, sample_noisy_x_lr=False, diffusion=None, sample_noisy_x_lr_t_thred=None):
        ...
        with th.enable_grad():
            ...
            if not x_lr is None:
                ...
                x_in_lr = x_in
                factor_r.requires_grad_()
                factor_g.requires_grad_()
                ...
                loss = loss - mse * args.img_guidance_scale - loss_col*10 # move xt toward the gradient direction
    ...
    for i, data in enumerate(dataloader):
        if args.use_img_for_guidance:
            ...
            cond_fn = lambda x,t,factor_r,factor_g,y : color_cond_fn(x, t, y=y, x_lr=image_lr, sample_noisy_x_lr=args.sample_noisy_x_lr, diffusion=diffusion, sample_noisy_x_lr_t_thred=args.sample_noisy_x_lr_t_thred)
        else:
            image, label = data
...
def create_argparser():
    ...
    parser.add_argument("--save_dir", default='/mnt/lustre/feiben/DDPM_Beat_GAN/generated_image_x0_color_withvariance', type=str, help='the directory to save the generate images')
