...
def create_argparser():
    ...
    parser.add_argument("--save_dir", default='/mnt/lustre/feiben/DDPM_Beat_GAN/generated_image_x0_blur_imagenet_scalesure', type=str, help='the directory to save the generate images')
