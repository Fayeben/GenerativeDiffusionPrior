...
def create_argparser():
    ...
    parser.add_argument("--save_dir", default='/nvme/feiben/feiben/GDP/generate_images/generated_image_x0_blur_text', type=str, help='the directory to save the generate images')
